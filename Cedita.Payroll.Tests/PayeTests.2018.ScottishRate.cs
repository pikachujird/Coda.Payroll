...
namespace Cedita.Payroll.Tests
{
    public partial class PayeTests
    {
        ...
        public void ScottishRatePayeCalculations2018()
        {
            ...
            Assert.AreEqual(555.62m, LegacyShim(2740.25m, "S45L", PayPeriods.Monthly, 1, 0, 0, false, 2018));
            Assert.AreEqual(555.64m, LegacyShim(2740.26m, "S45L", PayPeriods.Monthly, 1, 0, 0, false, 2018));
            ...
            Assert.AreEqual(128.31m, LegacyShim(632.83m, "S45L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            Assert.AreEqual(128.41m, LegacyShim(632.84m, "S45L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            Assert.AreEqual(1055.42m, LegacyShim(2893.83m, "S45L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            Assert.AreEqual(1055.44m, LegacyShim(2893.84m, "S45L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            ...
            Assert.AreEqual(540.4m, LegacyShim(2740.25m, "45L", PayPeriods.Monthly, 1, 0, 0, false, 2018));
            Assert.AreEqual(540.4m, LegacyShim(2740.26m, "45L", PayPeriods.Monthly, 1, 0, 0, false, 2018));
            ...
            Assert.AreEqual(124.8m, LegacyShim(632.83m, "45L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            Assert.AreEqual(124.8m, LegacyShim(632.84m, "45L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            ...
            Assert.AreEqual(1619.97m, LegacyShim(8758.26m, "S1185L", PayPeriods.Monthly, 4, 6002.79m, 602.6m, false, 2018));
            Assert.AreEqual(20642.01m, LegacyShim(52681.25m, "S1185L", PayPeriods.Monthly, 5, 14761.05m, 2222.57m, false, 2018));
            Assert.AreEqual(21367.89m, LegacyShim(50000m, "S1185L", PayPeriods.Monthly, 6, 67442.30m, 22864.58m, false, 2018));
            Assert.AreEqual(-16419.65m, LegacyShim(15000m, "SD0", PayPeriods.Monthly, 7, 117442.30m, 44232.47m, false, 2018));
            ...
            Assert.AreEqual(374.2m, LegacyShim(2021.09m, "S1185L", PayPeriods.Weekly, 4, 1386.2m, 139.04m, false, 2018));
            Assert.AreEqual(4763.52m, LegacyShim(12157.07m, "S1185L", PayPeriods.Weekly, 5, 3407.29m, 513.24m, false, 2018));
            Assert.AreEqual(6523m, LegacyShim(15000m, "S1185L", PayPeriods.Weekly, 6, 15564.36m, 5276.76m, false, 2018));
            Assert.AreEqual(-5330.29m, LegacyShim(242.84m, "SD0", PayPeriods.Weekly, 7, 30564.36m, 11799.76m, false, 2018));
            ...
            Assert.AreEqual(677.82m, LegacyShim(3000m, "S0T", PayPeriods.Monthly, 1, 0, 0, true, 2018));
            Assert.AreEqual(143.42m, LegacyShim(3000m, "S1185L", PayPeriods.Monthly, 2, 3000m, 677.82m, false, 2018));
            ...
            Assert.AreEqual(159.57m, LegacyShim(700m, "S0T", PayPeriods.Weekly, 1, 0, 0, true, 2018));
            Assert.AreEqual(33.01m, LegacyShim(700m, "S1185L", PayPeriods.Weekly, 2, 700m, 159.57m, false, 2018));
            ...
            Assert.AreEqual(196.06m, LegacyShim(895m, "S550L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            Assert.AreEqual(0m, LegacyShim(776m, "SNT", PayPeriods.Weekly, 2, 895m, 196.06m, true, 2018));
            ...
            Assert.AreEqual(235.83m, LegacyShim(810m, "SK396", PayPeriods.Weekly, 3, 0, 0, true, 2018));
            ...
            Assert.AreEqual(1155.47m, LegacyShim(5000m, "S1001L", PayPeriods.Monthly, 1, 0, 0, false, 2018));
            Assert.AreEqual(114.24m, LegacyShim(750m, "S999L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            Assert.AreEqual(162.44m, LegacyShim(900m, "S1000L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            Assert.AreEqual(408.44m, LegacyShim(1500m, "S1001L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            ...
            Assert.AreEqual(202.62m, LegacyShim(950m, "S750L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            Assert.AreEqual(137.5m, LegacyShim(275m, "SD1", PayPeriods.Weekly, 2, 950m, 202.62m, false, 2018));
            Assert.AreEqual(223.12m, LegacyShim(1000m, "S750L", PayPeriods.Weekly, 1, 0, 0, false, 2018));
            Assert.AreEqual(450m, LegacyShim(900m, "SD2", PayPeriods.Weekly, 2, 1000m, 223.12m, false, 2018));
        }
    }
}
